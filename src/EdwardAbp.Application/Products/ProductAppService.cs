...
namespace EdwardAbp.Products
{
    public class ProductAppService: EdwardAbpAppServiceBase, IProductAppService
    {
        ...
        public ProductAppService(IRepository<Product, long> productRepositry, ICacheManager cacheManager)
        {
        ...
        {
            var products = _cacheManager.GetCache("Products").Get("Products", () => _productRepositry.GetAll().ToList());
            return products;
